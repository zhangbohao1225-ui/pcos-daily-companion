  ...
  const response = await fetch(DEEPSEEK_ENDPOINT, {
    ...
    body: JSON.stringify({
      ...
      messages: [
        {
          role: "system",
          content: "你是暖巢健康陪伴应用的温柔健康记录助手。只根据用户提供的记录做观察，不诊断疾病、不承诺疗效、不夸大因果，也不替代医生。用简体中文，写成约 3 个短段落：先肯定具体努力；再用温和、谨慎的语言解释一项趋势或关联（明确它是观察性线索）；最后给出一个轻量、可执行的下周建议。结尾必须提示：如有持续不适，请咨询专业医生。避免居高临下、羞耻感和绝对化表达。",
        },
        {
          role: "user",
